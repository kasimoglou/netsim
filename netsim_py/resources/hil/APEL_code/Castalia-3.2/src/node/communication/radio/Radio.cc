		...
		case WC_SIGNAL_END:{
			 ...
			 */
			 ...
			 if( enablePERHil == signalID )
			 {
			   ...
			   if(selectForward)
                           {    
                               temp = system("java TestSerial -comm serial@/dev/ttyUSB0:115200 0 20 0 &");              // Forward Channel A -> B
                           }else{
                               temp = system("java TestSerial -comm serial@/dev/ttyUSB0:115200 0 21 0 &");              // Reverse Channel B -> A
                           }
...
void Radio::finishSpecific()
{
	...
	if( ( enablePERHil >= 0 ) && ( selectForward ) ){  
            ...
            */
            ...
            unlink(myfifo);
            remove("/home/gwho/myPipe");
            //temp = system("rm ~/myPipe");
            // temp = system("rm /home/gwho/myPipe");
	}
}
